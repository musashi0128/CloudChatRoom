...
class PrivateChatViewController: JSQMessagesViewController {
    ...
    override func didPressSend(_ button: UIButton!, withMessageText text: String!, senderId: String!, senderDisplayName: String!, date: Date!) {
        ...
        let rootRef = FIRDatabase.database().reference(fromURL: "https://cloudchatroom-33a28.firebaseio.com/").child("message").child(fromDBAddress).child(roomName)
    ...
    func getInfo(){
        ...
        let firebase = FIRDatabase.database().reference(fromURL: "https://cloudchatroom-33a28.firebaseio.com/").child("message").child(fromDBAddress).child(roomName)
